...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Clear email field and show success modal
      setEmail('');
  ...
  const handleSuccessModalClose = () => {
    ...
    if (resetUrl) {
      // In dev mode, redirect to reset page
        ...
        <div className="flex w-full flex-col justify-center bg-neutrals-01 p-8 lg:w-1/2 lg:p-16">
          <div className="mx-auto w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {error && (
                <div className="rounded-lg bg-errors-bg border border-errors-main/20 px-4 py-3 text-sm text-errors-main">
                  {error}
                </div>
              )}
