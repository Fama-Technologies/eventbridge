...
export async function sendPasswordResetEmail({
  ...
  const mailOptions = {
    from: `"EventBridge" <${process.env.EMAIL_USER}>`,
    to: to,
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>We received a request to reset your password for your EventBridge account. Click the button below to create a new password:</p>
          ...
          <div class="footer">
            <p><strong>This is an automated email from EventBridge. Please do not reply.</strong></p>
            <p>If you didn't request a password reset, you can safely ignore this email.</p>
            <p>If you're concerned about your account security, please contact our support team.</p>
            <p style="margin-top: 20px; color: #999;">&copy; ${new Date().getFullYear()} EventBridge. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
