  ...
  return (
    <footer className="bg-shades-white text-shades-black">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-12">
        <div className="relative overflow-hidden rounded-2xl mb-16 flex">
          {/* Left side - Light background with text */}
          <div className="flex-1 bg-[#f5f5f5] p-8 md:p-10">
            <h3 className="text-2xl md:text-3xl font-bold text-[#222222] mb-3">
              Planning an Event
            </h3>
          ...
          <Link
            href="/get-started"
            className="group relative flex items-center justify-center px-12 md:px-20 min-w-[200px] md:min-w-[280px]"
          >
            {/* Animated gradient background */}
            <div className="absolute inset-0 bg-gradient-to-r from-accents-peach via-[#e8a878] to-primary-01 animate-gradient-x" />
            <div className="absolute inset-0 bg-gradient-to-l from-primary-01 via-accents-orange to-transparent animate-gradient-x-reverse opacity-60" />
            
            <span className="relative flex items-center gap-6 text-[#222222] font-semibold text-lg whitespace-nowrap">
              Get Started <span className="text-2xl transition-transform group-hover:translate-x-1">→</span>
            </span>
          </Link>
        </div>
      </div>
