    ...
    return (
        <>
            <div
                ...
                className="group flex items-center justify-between p-5 bg-shades-white border border-neutrals-03 rounded-2xl hover:border-primary-01/30 hover:shadow-sm transition-all duration-200 cursor-pointer"
            >
